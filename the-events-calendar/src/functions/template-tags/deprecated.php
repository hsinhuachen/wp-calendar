...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	...
	if ( ! function_exists( 'the_event_flag' ) ) {
		/**
		 * @deprecated
		 *
		 * @param null $postId
		 */
		function the_event_flag( $postId = null ) {
			_deprecated_function( __FUNCTION__, '2.0', 'echo tribe_get_flag()' );
			echo tribe_get_flag( $postID );
		}
	}
	...
	if ( ! function_exists( 'sp_get_flag' ) ) {
		/**
		 * @deprecated
		 */
		function sp_get_flag( $postId = null ) {
			_deprecated_function( __FUNCTION__, '2.0', 'tribe_get_flag()' );

			return tribe_get_flag( $postId );
		}
	}
