...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	 ...
	 */
	function tribe_get_flag( $postId = null ) {
		$venue_id = tribe_get_venue_id( $postId );
		$output   = esc_html( tribe_get_event_meta( $venue_id, '_VenueFlag', true ) );
		 ...
		 * @param int $venue_id The venue ID.
		 */
		return apply_filters( 'tribe_get_flag', $output, $venue_id );
	}
