...
<?php endif; ?>
<tr class="venue tribe-linked-type-venue-flag">
	<td class='tribe-table-field-label'>Flag</td>
	<td>
		...
		<input
			...
			name="venue[Flag]"
			size="25"
			placeholder="flag-icon-tw"
			value='<?php echo ( isset( $_VenueFlag ) ? esc_attr( $_VenueFlag ) : '' ); ?>'
		/>
	</td>
</tr>
