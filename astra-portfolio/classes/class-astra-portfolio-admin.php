...
if ( ! class_exists( 'Astra_Portfolio_Admin' ) ) :
	...
	class Astra_Portfolio_Admin {
		...
		function meta_boxe_callback( $post ) {
			...
			$get_flags         = get_post_meta( $post->ID, 'astra-site-flag', true );
			...
			<table class="widefat astra-portfolio-table">
				...
				<tr class="astra-portfolio-row">
					<td class="astra-portfolio-heading"><?php _e( 'Add Flags', 'astra-portfolio' ); ?></td>
					<td class="astra-portfolio-content">
						<textarea class="astra-input-text" rows="4" name="astra-site-flag"><?php echo $get_flags; ?></textarea>
						<p class="description"><a href="https://www.iban.com/country-codes" target="_blank">country code</a></p>
					</td>
				</tr>
				<?php
		...
		function save_meta_boxes( $post_id = 0, $post = '', $update = '' ) {
			...
			if ( isset( $_POST['astra-site-flag'] ) ) {
				update_post_meta( $post_id, 'astra-site-flag', wp_kses_post( $_POST['astra-site-flag'] ) );
			}
